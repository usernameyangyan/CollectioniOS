...
class YYDefalutLoadingDialog:BaseDialog{
    ...
    func setMessageColor(color:UIColor) -> YYDefalutLoadingDialog {
        defaultContentView!.labelMessage.textColor=color
        return self
    }
    
    func setMessageSize(fontSize:CGFloat) -> YYDefalutLoadingDialog {
        defaultContentView!.labelMessage.font=UIFont.systemFont(ofSize: fontSize)
        return self
    }
    
    func setContentViewCornerRadius(radius:CGFloat) -> YYDefalutLoadingDialog {
        defaultContentView!.layer.cornerRadius=radius
        return self
    }
    
    func setIndicatorColor(color:UIColor) -> YYDefalutLoadingDialog {
        defaultContentView!.indicatorView.color=color
        return self
    }
    
    func setContentViewBackgroundColor(color:UIColor)-> YYDefalutLoadingDialog{
        defaultContentView!.backgroundColor=color
        return self
    }
    
    func setAnimationOption(animationOption:YYDialogAnimationOptions)->YYDefalutLoadingDialog{
        defaultContentView!.setAnimationOption(animationOption: animationOption)
        return self
    }
    
    func setMaskLayer(showMaskLayer:Bool)->YYDefalutLoadingDialog{
    ...
    func setMaskLayerAlpha(alpha:CGFloat)->YYDefalutLoadingDialog{
