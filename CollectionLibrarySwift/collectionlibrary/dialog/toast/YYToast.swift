...
class YYToast{
    ...
    func setCornerRadius(cornerRadius:CGFloat) ->  YYToast{
        self.cornerRadius=cornerRadius
        return self
    }
    
    private var lineSpacing:CGFloat=10
    func setLineSpacing(lineSpacing:CGFloat) -> YYToast {
        self.lineSpacing=lineSpacing
        return self
    }
    
    private var textColor:UIColor=UIColor.white
    func setTextColor(textColor:UIColor) -> YYToast {
        self.textColor=textColor
        return self
    }
    
    private var contentViewBackgroudColor:UIColor=UIColor.black
    func setContentViewBackgroudColor(contentViewBackgroudColor:UIColor) -> YYToast {
