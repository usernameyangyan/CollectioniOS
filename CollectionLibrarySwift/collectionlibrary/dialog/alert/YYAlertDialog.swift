...
typealias YYAlertViewClickButtonBlock = ((_ alertView:YYDefaultAlertDialog)->Void)?
...
//MARK:默认
class YYDefaultAlertDialog:BaseDialog{
    ...
    func setContentViewWidth(width:CGFloat)->YYDefaultAlertDialog{
        defaultContentView!.setContentViewWidth(width: width)
        return self
    }
    
    func setContentViewBackgroundColor(color:UIColor)->YYDefaultAlertDialog{
        defaultContentView!.setContentViewBackgroundColor(color: color)
        return self
    }
    
    
    func setTitleColor(color:UIColor)->YYDefaultAlertDialog{
        defaultContentView!.setTitleColor(color: color)
        return self
    }
    
    func setTitleSize(ofSize:CGFloat)->YYDefaultAlertDialog{
        defaultContentView!.setTitleSize(ofSize: ofSize)
        return self
    }
    
    func setContentColor(color:UIColor) -> YYDefaultAlertDialog {
        defaultContentView!.setContentColor(color: color)
        return self
    }
    
    func setContentSize(ofSize:CGFloat) -> YYDefaultAlertDialog {
        defaultContentView?.labelMessage.font = UIFont.systemFont(ofSize: ofSize)
        return self
    }
    
    func setAnimationOption(animationOption:YYDialogAnimationOptions)->YYDefaultAlertDialog{
        defaultContentView!.setAnimationOption(animationOption: animationOption)
        return self
    }
    
    func setMaskLayer(showMaskLayer:Bool)->YYDefaultAlertDialog{
    ...
    func setMaskLayerAlpha(alpha:CGFloat)->YYDefaultAlertDialog{
    ...
    func setSubmitButtonListener(clickSubmitBlock:YYAlertViewClickButtonBlock?) -> YYDefaultAlertDialog {
        defaultContentView!.setSubmitButtonListener(clickSubmitBlock: clickSubmitBlock)
        return self
    }
    
    
    func setCancleButtonListener(clickCancelBlock:YYAlertViewClickButtonBlock) -> YYDefaultAlertDialog {
        defaultContentView!.setCancleButtonListener(clickCancelBlock: clickCancelBlock)
        return self
    }
    
    func setButtonType(btnType:YYShowBtnStyle) -> YYDefaultAlertDialog {
        defaultContentView!.setButtonType(btnType: btnType)
        return self
    }
    
    func setSubmitBtnBackgroundColor(color:UIColor) -> YYDefaultAlertDialog {
        defaultContentView!.setSubmitBtnBackgroundColor(color: color)
        return self
    }
    
    func setSubmitBtnContent(title:String) -> YYDefaultAlertDialog {
        defaultContentView!.setSubmitBtnContent(title: title)
        return self
    }
    
    func setSubmitBtnContentColor(color:UIColor) -> YYDefaultAlertDialog {
        defaultContentView!.setSubmitBtnContentColor(color: color)
        return self
    }
    
    func setSubmitBtnSize(ofSize:CGFloat) -> YYDefaultAlertDialog {
        defaultContentView!.setSubmitBtnSize(ofSize: ofSize)
        return self
    }
    
    
    func setCancelBtnBackgroundColor(color:UIColor) -> YYDefaultAlertDialog {
        defaultContentView!.setCancelBtnBackgroundColor(color: color)
        return self
    }
    
    func setCancelBtnContent(title:String) -> YYDefaultAlertDialog {
        defaultContentView!.setCancelBtnContent(title: title)
        return self
    }
    
    func setCancelBtnContentColor(color:UIColor) -> YYDefaultAlertDialog {
        defaultContentView!.setCancelBtnContentColor(color: color)
        return self
    }
    
    func setCancelBtnSize(ofSize:CGFloat) -> YYDefaultAlertDialog {
        defaultContentView!.setCancelBtnSize(ofSize: ofSize)
        return self
    }
    
    func setCornerRadius(radius:CGFloat)->YYDefaultAlertDialog{
...
class YYAlertDialog{
    ...
    class CustomDialog{
        ...
        init(custom:BaseDialogContentView) {
        ...
        func setMaskLayer(showMaskLayer:Bool)->CustomDialog{
        ...
        func setMaskLayerAlpha(alpha:CGFloat)->CustomDialog{
