...
public protocol DataResponseSerializerProtocol {
    ...
    var serializeResponse: (URLRequest?, HTTPURLResponse?, Data?, Error?) -> HttpBaseResult<SerializedObject> { get }
}
...
public struct DataResponseSerializer<Value>: DataResponseSerializerProtocol {
    ...
    /// A closure used by response handlers that takes a request, response, data and error and returns a result.
    public var serializeResponse: (URLRequest?, HTTPURLResponse?, Data?, Error?) -> HttpBaseResult<Value>
    ...
    public init(serializeResponse: @escaping (URLRequest?, HTTPURLResponse?, Data?, Error?) -> HttpBaseResult<Value>) {
...
public protocol DownloadResponseSerializerProtocol {
    ...
    var serializeResponse: (URLRequest?, HTTPURLResponse?, URL?, Error?) -> HttpBaseResult<SerializedObject> { get }
}
...
public struct DownloadResponseSerializer<Value>: DownloadResponseSerializerProtocol {
    ...
    /// A closure used by response handlers that takes a request, response, url and error and returns a result.
    public var serializeResponse: (URLRequest?, HTTPURLResponse?, URL?, Error?) -> HttpBaseResult<Value>
    ...
    ///
    /// - returns: The new generic response serializer instance.
    public init(serializeResponse: @escaping (URLRequest?, HTTPURLResponse?, URL?, Error?) -> HttpBaseResult<Value>) {
        self.serializeResponse = serializeResponse
    }
}
...
extension Request {
    ...
    public static func serializeResponseData(response: HTTPURLResponse?, data: Data?, error: Error?) -> HttpBaseResult<Data> {
