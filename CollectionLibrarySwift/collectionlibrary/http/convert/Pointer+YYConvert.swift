...
extension UnsafePointer {
    var yy_raw: UnsafeRawPointer {
        return UnsafeRawPointer(self)
    }
    var yy_mutable: UnsafeMutablePointer<Pointee> {
        return UnsafeMutablePointer(mutating: self)
    }
}

extension UnsafeMutablePointer {
    var yy_raw: UnsafeMutableRawPointer {
        return UnsafeMutableRawPointer(self)
    }
    
    var yy_immutable: UnsafePointer<Pointee> {
        return UnsafePointer(self)
    }
}

extension UnsafeRawPointer {
    var yy_mutable: UnsafeMutableRawPointer {
...
extension UnsafeMutableRawPointer {
    var yy_immutable: UnsafeRawPointer {
        return UnsafeRawPointer(self)
    }
    
    func yy_set(_ value: Any, _ type: Any.Type) {
        return typeProxy(type)._set(value, self)
    }
    
    func yy_get(_ type: Any.Type) -> Any {
