//
//  CumstonRefreshViewController.swift
...
class CumstonRefreshViewController:YYIBaseTableViewController{
    ...
    override func viewDidLoad() {
        ...
        let refreshView:CumstonRefreshHeaderAnimator=CumstonRefreshHeaderAnimator.init(frame: .zero)
        let footView:CumstonRefreshFooterAnimator=CumstonRefreshFooterAnimator.init(frame: .zero)
