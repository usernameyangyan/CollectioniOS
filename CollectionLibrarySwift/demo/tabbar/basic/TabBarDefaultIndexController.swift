//
//  TabBarDefaultIndexController.swift
...
class TabBarDefaultIndexController:YYTabBarController{
    ...
    override func viewDidLoad() {
        ...
        let tabSetting:TabBarSetting=TabBarSetting(vc:self,tabBarBuilder: builder)
        tabSetting.setDefaultTabIndex(index: 2)
