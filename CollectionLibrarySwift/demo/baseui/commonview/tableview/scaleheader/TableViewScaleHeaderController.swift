//
//  TableViewScaleHeaderController.swift
...
class TableViewScaleHeaderController:YYIBaseTableViewController{
    ...
    override func viewDidLoad() {
        ...
        NavigationUtils
            ...
            .setTitle(title: InternationalUtils.getInstance.getString("tableview_sclaeheader"))
            .setBackBarButtonItem(style: .image(UIImage(named: "back_btn")),tintColor: UIColor.gray)
            .build()
        
        PositionSettingUtils.position(aboveView: self.navigation.bar, childView: tableView, style: .fixed)
        
        tableView.separatorStyle = .none
        
        tableView.addSubview(ScaleHeaderView(frame: self.view.bounds))
