...
@objc public protocol CommonCollectionViewLayoutDelegate {
    //waterFall的列数
...
open class CommonCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    public init(lineSpacing: CGFloat, columnSpacing: CGFloat, sectionInsets: UIEdgeInsets) {
        super.init()
