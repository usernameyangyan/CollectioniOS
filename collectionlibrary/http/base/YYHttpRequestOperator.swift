...
class HttpRequest{
    ...
    ///
    /// - returns: The created `UploadRequest`.
    public class func upload(_ fileURL: URL, with urlRequest: URLRequestConvertible) -> UploadRequest {
    ...
    ///
    /// - returns: The created `UploadRequest`.
    public class func upload(_ data: Data, with urlRequest: URLRequestConvertible) -> UploadRequest {
    ...
    ///
    /// - returns: The created `UploadRequest`.
    public class  func upload(_ stream: InputStream, with urlRequest: URLRequestConvertible) -> UploadRequest {
