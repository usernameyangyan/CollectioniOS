...
public enum YYTabBarItemContentMode : Int {
...
open class YYTabBarItemContentView: UIView {
    ...
    open var itemContentMode: YYTabBarItemContentMode = .alwaysTemplate {
        didSet {
            self.updateDisplay()
        }
    }
    ...
    open var badgeColor: UIColor? {
        didSet {
            if let _ = badgeColor {
                ...
                self.badgeView.badgeColor = YYTabBarItemBadgeView.defaultBadgeColor
            }
        }
    }
    open var badgeView: YYTabBarItemBadgeView = YYTabBarItemBadgeView() {
        willSet {
