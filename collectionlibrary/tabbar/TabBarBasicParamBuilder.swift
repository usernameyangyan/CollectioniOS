...
//MARK：使用默认还是自定义
open class TabBarBasicParamBuilder{
    
    
    public class func with(childVCs: [UIViewController],normalImgs:[String],selectImgs:[String],titles:[String]) -> TabBarBasicParamBuilder{
    ...
    public func defultStyle()->DefuletStyle{
        return DefuletStyle()
    }
    
    
    
    public class DefuletStyle{
        
        
        public func setTextColor(txtColor:UIColor)->DefuletStyle{
        ...
        public func setSelectTextColor(selectTxtColor:UIColor)->DefuletStyle{
        ...
        public func setImgColor(imageColor:UIColor)->DefuletStyle{
        ...
        public func setSelectImgColor(selectImageColor:UIColor)->DefuletStyle{
        ...
        public func irregularity()->Irregularity{
        ...
        public class Irregularity{
            ...
            public init(defaultStyleInstance:DefuletStyle) {
                self.defaultStyleInstance=defaultStyleInstance
            }
            
            public func setIrregularityIndex(irregularIndex:Int)->Irregularity {
            ...
            public func setIrregularityBorderColor(borderColor:UIColor) -> Irregularity {
            ...
            public func setIrregularityBorderWidth(borderWidth:CGFloat) -> Irregularity {
            ...
            public func setIrregularityBackgroundColor(backgroundColor:UIColor) -> Irregularity {
        ...
        public func bouncesAnimationStyle()->DefuletStyle{
        ...
        public func setRemindUseClickIndex(remindUseClickIndex:Int) -> DefuletStyle {
        ...
        public func backgroundColorWithoutTitlesAnimationStyle()->BackgroundColorAnimationStyle{
        ...
        //MARK:背景动画
        public class BackgroundColorAnimationStyle{
            ...
            public func setItemBgColor(normalItemBgColor:UIColor) -> BackgroundColorAnimationStyle{
            ...
            public func setSelectItemBgColor(selectItemBgColor:UIColor) -> BackgroundColorAnimationStyle{
            ...
            public func setSwithcBouncesAnimation(switchBgAnimation:Bool) -> BackgroundColorAnimationStyle{
    ...
    //MARK:自定义设置
    public func cumstomStyle()->CumstomStyle{
        return CumstomStyle()
        
    }
    
    public class CumstomStyle{
    
        public func setCumstonTabBarItemView(cumstomItemView: [YYTabBarItemContentView]) -> CumstomStyle {
